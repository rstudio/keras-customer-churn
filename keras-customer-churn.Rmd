...
model_keras <- load_model_hdf5('keras_model.hdf5', compile = FALSE)
...
![](www/business-science-logo.png){width=24} [Business Science](https://www.business-science.io/)

![](www/rstudio.png){width=24} [RStudio](https://www.rstudio.com)
